...
class ReportController extends Controller
{
    ...
    public function bulkAction(Request $request)
    {
        ...
        if ($action === 'delete') {
            ...
            return redirect()->route('admin.reports.index')->with('success', "$count laporan berhasil dihapus.");
        } elseif ($action === 'publish') {
            Document::whereIn('id', $ids)->update(['is_published' => true]);
            return redirect()->route('admin.reports.index')->with('success', "$count laporan berhasil dipublikasikan.");
        } elseif ($action === 'unpublish') {
            Document::whereIn('id', $ids)->update(['is_published' => false]);
            return redirect()->route('admin.reports.index')->with('success', "$count laporan berhasil ditarik dari publikasi.");
        }
