            ...
            <table class="table table-hover align-middle mb-0">
                <thead class="bg-light text-uppercase text-secondary small">
                    <tr>
                        ...
                        <th class="px-4 py-3 border-0">Pemohon</th>
                        <th class="px-4 py-3 border-0">Informasi yang Diminta</th>
                    ...
                    <tr class="border-bottom">
                        ...
                        <td class="px-4 py-3">
                            <small class="text-muted d-block text-truncate" style="max-width: 250px;">
                                {{ Str::limit($item->info_requested, 50) }}
                            </small>
                        </td>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-sm">
                                    <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
                                        <div class="modal-body p-4 text-center">
                                            ...
                                            <h5 class="fw-bold mb-2">Hapus Permohonan?</h5>
                                            <p class="text-muted small mb-4">Tiket <strong>{{ $item->ticket_number }}</strong> akan dihapus permanen.</p>
                                            
                                            <form action="{{ route('admin.requests.destroy', $item->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                    ...
                    <tr>
                        <td colspan="6" class="text-center py-5">
                            <div class="py-5">
                                ...
                                <h5 class="text-muted fw-bold">Belum ada permohonan</h5>
                                <p class="text-muted small">Permohonan informasi baru akan muncul di sini.</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
