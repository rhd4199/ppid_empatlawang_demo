...
<div class="card border-0 shadow-lg rounded-4 overflow-hidden">
    <div class="card-header bg-gradient bg-primary text-white py-4 d-flex justify-content-between align-items-center">
        <div>
            <h5 class="mb-1 fw-bold"><i class="fas fa-file-alt me-2"></i>Daftar Informasi Publik</h5>
            <p class="mb-0 text-white-50 small">Kelola dokumen publik dengan mudah dan cepat.</p>
        </div>
    ...
    <div class="card-body p-0">
        ...
        <div class="table-responsive">
            <!-- Bulk Action Form -->
            <form action="{{ route('admin.info-public.bulk-action') }}" method="POST" id="bulkActionForm">
                @csrf
            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody class="border-top-0">
                    ...
                    <tr class="border-bottom">
                        ...
                        <td class="px-4 py-3">
                            @php
                                $categoryName = str_replace('informasi-publik-', '', $item->category);
                                $categoryName = ucwords(str_replace('-', ' ', $categoryName));
                                $badgeClass = match($item->category) {
                                    'informasi-publik-berkala' => 'bg-info text-info',
                                    'informasi-publik-serta-merta' => 'bg-warning text-warning',
                                    'informasi-publik-setiap-saat' => 'bg-success text-success',
                                    'informasi-publik-dikecualikan' => 'bg-danger text-danger',
                        ...
                        <td class="px-4 py-3 text-center">
                            <form action="{{ route('admin.info-public.toggle-status', $item->id) }}" method="POST">
                                @csrf
                            ...
                            <div class="modal fade text-start" id="editModal{{ $item->id }}" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content border-0 shadow-lg rounded-4">
                                        ...
                                        <form action="{{ route('admin.info-public.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <div class="modal-body p-4">
                                                <div class="mb-3">
                                                    <label class="form-label fw-bold small text-uppercase text-muted">Judul Informasi</label>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select bg-light border-0" name="category" required>
                                                        <option value="informasi-publik-berkala" {{ $item->category == 'informasi-publik-berkala' ? 'selected' : '' }}>Berkala</option>
                                                        <option value="informasi-publik-serta-merta" {{ $item->category == 'informasi-publik-serta-merta' ? 'selected' : '' }}>Serta Merta</option>
                                                        <option value="informasi-publik-setiap-saat" {{ $item->category == 'informasi-publik-setiap-saat' ? 'selected' : '' }}>Setiap Saat</option>
                                                        <option value="informasi-publik-dikecualikan" {{ $item->category == 'informasi-publik-dikecualikan' ? 'selected' : '' }}>Dikecualikan</option>
                                                    </select>
                                                </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-sm">
                                    <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
                                        <div class="modal-body p-4 text-center">
                                            ...
                                            <form action="{{ route('admin.info-public.destroy', $item->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                    ...
                    <tr>
                        <td colspan="5" class="text-center py-5">
                            <div class="py-5">
                                ...
                                <p class="text-muted small">Silakan tambahkan dokumen informasi publik baru.</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
...
<div class="modal fade" id="createModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4">
            ...
            <form action="{{ route('admin.info-public.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body p-4">
                    <div class="mb-3">
                        <label class="form-label fw-bold small text-uppercase text-muted">Judul Informasi</label>
                        <input type="text" class="form-control bg-light border-0" name="title" required placeholder="Contoh: Laporan Keuangan 2024">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select bg-light border-0" name="category" required>
                            ...
                            <option value="informasi-publik-berkala">Berkala</option>
                            <option value="informasi-publik-serta-merta">Serta Merta</option>
                            <option value="informasi-publik-setiap-saat">Setiap Saat</option>
                            <option value="informasi-publik-dikecualikan">Dikecualikan</option>
                        </select>
                    </div>
