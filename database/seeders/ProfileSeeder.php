...
class ProfileSeeder extends Seeder
{
    ...
    {
        Profile::firstOrCreate(['slug' => 'tentang-ppid'], [
            'title' => 'Tentang PPID',
        ...
        Profile::firstOrCreate(['slug' => 'visi-misi'], [
            'title' => 'Visi dan Misi',
        ...
        Profile::firstOrCreate(['slug' => 'struktur-organisasi'], [
        ...
        Profile::firstOrCreate(['slug' => 'tugas-fungsi'], [
